    ...
    <div class='all'>
        ...
        <div class='select'>
            ...
            <div class='order'>
                ...
                <span class='b c' @click='change' style='background-color: rgb(252, 238, 238); color:#cd0200'>上升最快</span>
        ...
        <div class='page'>
            <el-pagination @current-change="handleCurrentChange" background layout="prev, pager, next" :total="total" :current-page="page" :page-size="50">
            </el-pagination>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        getMv(offset) {
            this.loading=true
            this.$api.getAllMV(this.now_area, this.now_type, this.now_order, 50, offset).then(res => {
                this.mv = res.data
            }).then(()=>{
                this.loading=false
            })
        ...
        getTotal() {
            this.$api.getAllMV(this.now_area, this.now_type, this.now_order, 1000, 0).then(res => {
