<template>
    <div class='all'>
        ...
        <div class='page'>
            <el-pagination @current-change="handleCurrentChange" background layout="prev, pager, next" :total="total" :current-page="page" :page-size="30">
            </el-pagination>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange(val) {
            this.page = val
            this.song = this.songs.slice(this.left + 30 * (val - 1), this.right + 30 * (val - 1))
        }
    },
    created() {
