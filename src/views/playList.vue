        ...
        <div class="song">
            <el-tabs v-model="activeName" stretch>
                <el-tab-pane label="歌曲列表" name="first">
                    <el-table :data="tableData" :key='tableData.id' fit stripe style="width: 100%" @cell-click='toSong' class='temp'>
                ...
                <el-tab-pane label="评论" name="second">
                    ...
                    <!-- 分页器 -->
                    <div class='page'>
                        <el-pagination @current-change="handleCurrentChange" background layout="prev, pager, next" :total="total" :current-page="page" :page-size="6" hide-on-single-page>
                        </el-pagination>
                    </div>
                </el-tab-pane>
            </el-tabs>
